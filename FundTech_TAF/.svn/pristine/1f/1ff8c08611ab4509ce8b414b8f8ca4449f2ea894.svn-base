...
public class QueueOperation {
    ...
    public String sendMessage(String queueName, String jmsCorrelationId,
        ...
        if (!jmsCorrelationId.equalsIgnoreCase("Null")) {
        	String[] customPropValue = jmsCorrelationId.split(Separator.SEPARATOR_COMMA);
            for(String customProp : customPropValue){
            	if(customProp.split(":")[0].contains("CUSTOM")){
            		textMessage.setStringProperty(customProp.split(Separator.SEPARATOR_COLON)[0].split(Separator.SEPARATOR_DOUBLE_EXCLAMATION)[1], customProp.split(Separator.SEPARATOR_COLON)[1]);
            	}
            	else{
            		 textMessage.setJMSCorrelationID(customProp.split(Separator.SEPARATOR_COLON)[0]);
            	}
            }
        }
    ...
    public String consumeAndSearch(String queueName, String searchString,
        String messagePropertyName, String jmsIdPropertyname, String correlationProperty, String queueProperty) throws IOException, JMSException {
        ...
        String currentQueuePropertyValue = "";
        do {
            System.out.print(".");
            ...
            if (message != null) {
                ...
                if(message.propertyExists(queueProperty)){
                	currentQueuePropertyValue = message.getStringProperty(queueProperty);
                }  
                ...
                if (currentMessage.contains(searchString)) {
                    ...
                    System.out.println("Jms Queue Property "+queueProperty+" : " + currentQueuePropertyValue);
        ...
        if (count == 0) {
            ...
            if (null != queueProperty && null != currentQueuePropertyValue ) {
            	propertNameValue.put(queueProperty, currentQueuePropertyValue);
            }
    ...
    public String browseAndSearchMessage(String queueName, String searchString,
        ...
        while (messages.hasMoreElements()) {
            ...
            if(current.propertyExists(queueProperty)){
            	currentQueuePropertyValue = current.getStringProperty(queueProperty);
            }           
